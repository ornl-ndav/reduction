 ...
 * generated by the <i>fit_linear_background</i> function. The function returns
 * TRUE if the two values compared \f$output\f$ and \f$true\_output\f$ match,
 * and returns FALSE if they do not match.
 *
 * \param output (INPUT) is the value created by <i>fit_linear_background</i>
 * \param output_err2 (INPUT) is the square of the uncertainty in the
 * value created by <i>fit_linear_background</i>
...
/**
 * Function that generates the data using the <i>fit_linear_background</i> function
 * (as described in the documentation of the <i>fit_linear_background</i> function)
...
bool test_func(NumT key){ // key forces correct test to happen
  ...
  Utils::fit_linear_background(input1, input1_err2, 0, NUM_VAL-1,
                          output, output_err2);
