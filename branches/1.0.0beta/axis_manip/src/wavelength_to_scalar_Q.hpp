...
namespace AxisManip
{
                         ...
                         void *temp=NULL)
  {
    ...
    retstr += __wavelength_to_scalar_Q_static(polar_angle, _4Pi, sin,
                                              sin2, cos2);
                                  ...
                                  NumT & cos2)
  {
    ...
    sin=static_cast<NumT>(std::sin(static_cast<double>(polar_angle)));
    sin2=sin*sin;
    cos2=static_cast<NumT>(std::cos(static_cast<double>(polar_angle)));
    cos2=cos2*cos2;
