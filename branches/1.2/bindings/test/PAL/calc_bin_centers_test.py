...
# $Id$
#
# \file bindings/test/PAL/calc_bin_centers_test.py
#
...
##
# \defgroup calc_bin_centers_test pal::calc_bin_centers_test
# \{
#
# This test compares the output data ($output\_vv\f$)
# calculated by the binding module <i>calc_bin_centers.py</i> of the
...
def initialize_true_outputs(key):
    ...
    if (key == "double"):
      ...
      # initialize the correct outputs for vector vector case
        true_output_vv.append(float(1.5))
        true_output_vv_err2.append(float(0.825))
        true_output_vv.append(float(2.5))
        true_output_vv_err2.append(float(1.375))
        true_output_vv.append(float(3.5))
        true_output_vv_err2.append(float(1.925))
        true_output_vv.append(float(4.5))
        true_output_vv_err2.append(float(2.475))
        true_output_vv.append(float(5.5))
        true_output_vv_err2.append(float(3.0250000000000004))
...
if __name__ == "__main__":
    ...
    print "##########################################################"
    print "#   Checking calc_bin_centers Python Abstraction layer   #"
    print "##########################################################"
    print
    ...
    # vv case
    output_vv, output_vv_err2 = utils.calc_bin_centers(axis, axis_err2)
