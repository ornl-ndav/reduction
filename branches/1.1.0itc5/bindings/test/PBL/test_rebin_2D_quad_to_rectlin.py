...
TruthOutput_D.append(0.3125)
TruthOutput_D.append(0.9375)
TruthOutput_D.append(0.0)
TruthOutput_D.append(0.0)
TruthOutput_D.append(0.0)
TruthOutput_D.append(3.75)
TruthOutput_D.append(1.25)
TruthOutput_D.append(0.0)
TruthOutput_D.append(0.0)
TruthOutput_D.append(0.0)
TruthOutput_D.append(3.75)
...
TruthOutput_Err2_D.append(0.0009765625)
TruthOutput_Err2_D.append(0.0087890625)
TruthOutput_Err2_D.append(0.0)
TruthOutput_Err2_D.append(0.0)
TruthOutput_Err2_D.append(0.0)
TruthOutput_Err2_D.append(0.064453125)
TruthOutput_Err2_D.append(0.009765625)
TruthOutput_Err2_D.append(0.0)
TruthOutput_Err2_D.append(0.0)
TruthOutput_Err2_D.append(0.0)
TruthOutput_Err2_D.append(0.064453125)
...
TruthOutput_Err2_D.append(0.0)
TruthOutput_Err2_D.append(0.0)
TruthOutput_Err2_D.append(0.015625)

TruthFracArea_D = DoubleNessiVector()
TruthFracArea_D.append(0.03125)
TruthFracArea_D.append(0.09375)
TruthFracArea_D.append(0.0)
TruthFracArea_D.append(0.0)
TruthFracArea_D.append(0.0)
TruthFracArea_D.append(0.375)
