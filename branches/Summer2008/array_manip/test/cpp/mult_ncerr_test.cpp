 ...
 * \f$output\_ss\f$) calculated by the library function <i>mult_ncerr</i> and 
 * described in section 3.3 and 3.8 of the <i>SNS 107030214-TD0001-R00, "Data 
 * Reduction Library Software Requirements and Specifications"</i> with the true 
 * output data (\f$true\_output\_vs\f$, \f$true\_output\_vv\f$, 
 ...
 * of the array \f$input1\f$, \f$input1[NUM\_VAL-1]\f$,
 * \f$input2\f$, \f$input2[NUM\_VAL-1]\f$
 *
 ...
 * generated by the <i>mult_ncerr</i> function for the vs, vv, and ss cases.
...
bool test_func(NumT key, string debug){ // key forces correct test to happen
  ...
  ArrayManip::mult_ncerr(input1[NUM_VAL-1], input1_err2[NUM_VAL-1],
                         input2[NUM_VAL-1], input2_err2[NUM_VAL-1],
