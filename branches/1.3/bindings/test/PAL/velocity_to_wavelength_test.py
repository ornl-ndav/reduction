...
# $Id$
#
# \file bindings/test/PAL/velocity_to_wavelength_test.py
#
...
# calculated by the binding module <i>velocity_to_wavelength.py</i> of the
...
##
#
# This function initializes the values of arrays, \f$velocity\f$, and
# \f$velocity_err2\f$.
#
# \returns
...
# NessiLists \f$velocity\f$ and \f$velocity_err2\f$ (\f$velocity[0]\f$
# and \f$velocity\_err2[0]\f$
#
...
if __name__ == "__main__":
    ...
    print "############################################################"
    print "# Checking velocity_to_wavelength Python Abstraction layer #"
    print "############################################################"
    print
    ...
    # vv case
    (output_vv,
     output_vv_err2) = axis_manip.velocity_to_wavelength(velocity,
                                                         velocity_err2)
    ...
    # ss case
    (output_ss,
     output_ss_err2) = axis_manip.velocity_to_wavelength(velocity[0],
                                                         velocity_err2[0])
