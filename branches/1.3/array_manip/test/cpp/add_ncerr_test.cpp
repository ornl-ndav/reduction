 ...
 * \{
 *
 * This test compares the output data (\f$output\_vs\f$, \f$output\_vv\f$, 
 * \f$output\_ss\f$, and \f$output\_mul\_vv\f$)
 ...
 * data (\f$true\_output\_vs\f$, \f$true\_output\_vv\f$, \f$true\_output\_ss\f$, * \f$true\_output\_mul\_vv\f$) manually calculated.
 ...
 *
 * For the ss case, the scalars used are the last elements 
 * of the array \f$input1\f$, \f$input1[NUM\_VAL - 1]\f$, \f$input2\f$,
 * and \f$input2[NUM\_VAL - 1]\f$
 *
 ...
 * \param true_output_ss (OUTPUT) is the true array for the ss case
 * \param true_output_ss_err2 (OUTPUT) is the square of the uncertainty
 * in the true array for the ss case
 */
template <typename NumT>
                             ...
                             NumT & true_output_ss_err2)
{
  ...
  true_output_ss = static_cast<NumT>(6.);  // =4+2
 ...
 * generated by the <i>add_ncerr</i> function for the vs, vv, and ss cases.
 ...
 * \param output_ss (INPUT) is the scalar created by <i>add_ncerr</i>
 * for the ss case
 * \param output_ss_err2 (INPUT) is the square of the uncertainty in the
 * scalar created by <i>add_ncerr</i> for the ss case
 * \param true_output_ss (INPUT) is the true scalar for the ss case
 * \param true_output_ss_err2 (INPUT) is the square of the uncertainty in the
 * true scalar for the ss case
...
bool test_func(NumT key, string debug){ // key forces correct test to happen
  ...
  ArrayManip::add_ncerr(input1[NUM_VAL-1], input1_err2[NUM_VAL-1],
                        input2[NUM_VAL-1], input2_err2[NUM_VAL-1],
