...
{
  /**
   * \defgroup abs_val ArrayManip::abs_val
   * \{
   */

  /**
   * \brief This function is described in section 3.55
   *
   ...
   * array.
   *
   * \param input (INPUT) is the array to have its elements absolute valued
  ...
  /**
   * \brief This function is described in section 3.6 except both
   * arrays are single values
   *
   * This function adds two scalars according to the equation
   * \f[
   ...
   * \f]
   * Where \f$data_o\f$ is the output scalar, \f$data_1\f$ is the 
   * first scalar being added, \f$data_2\f$ is the second scalar
   * being added, \f$\sigma_o\f$ is the uncertainty of the output
   * scalar, \f$\sigma_1\f$ is the uncertainty in the first scalar,
   * and \f$\sigma_2\f$ is the uncertainty in the second scalar.
   *
   * This function is an adaptation from the ARCS reduction software
   * written by Tim Kelley (CalTech)
   *
   * \param input1 (INPUT) is the first scalar to be added
   * \param input1_err2 (INPUT) is the square of the uncertainty in
   *        the first scalar to be added
   * \param input2 (INPUT) is the second scalar to be added
   * \param input2_err2 (INPUT) is the square of the uncertainty in
   *        the second scalar to be added
   * \param output (OUTPUT) the result scalar
   * \param output_err2 (OUTPUT) the square of the uncertainty in the
   *        result scalar
   *
   * \param temp holds temporary memory to be passed to the function
  ...
  /**
   * \brief This function is described in section 3.6 and is for 
   *        multi-dimensional vectors as 1D.
   *
   ...
   * \param input1_err2 (INPUT) is the square of the uncertainty in
   *        the first array to be added
   * \param i1_start (INPUT) is the starting index for getting information from
   *        input1 and input1_err2
   * \param i1_span (INPUT) is the number of spots to jump in the vector to 
   *        retrieve the next index for information from input1 and input1_err2
   * \param input2 (INPUT) is the second array to be added
   * \param input2_err2 (INPUT) the square of the uncertainty in the
   *        second array to be added
   * \param i2_start (INPUT) is the starting index for getting information from
   ...
   * \param output_err2 (OUTPUT) the square of the uncertainty in the
   *        result array
   * \param o_start (OUTPUT) is the starting index for getting information from
   *        input1 and input1_err2
   * \param o_span (OUTPUT) is the number of spots to jump in the vector to 
   *        retrieve the next index for information from input1 and input1_err2
   *
   * \param temp holds temporary memory to be passed to the function
   *
  ...
  /**
   * \brief This function is described in section 3.9 except both arrays
   * are single values
   *
   * This function divides two scalars according to the equation
   * \f[
   * data_o = data_1/data_2
   * \f]
   * and the uncorrelated uncertainties will be processed according to
   ...
   * \f]
   * where \f$data_o\f$ is the output scalar, \f$data_1\f$ is the 
   * scalar being divided, \f$data_2\f$ is the dividing scalar,
   * \f$\sigma_o\f$ is the uncertainty of the output scalar, \f$\sigma_1\f$ 
   * is the uncertainty in the scalar being divided, \f$\sigma_2\f$ is the
   * uncertainty in the dividing scalar.
   *
   * This function is an adaptation from the ARCS reduction software written
   * by Tim Kelley (CalTech).
   *
   * \param input1 (INPUT) is the scalar to be divided from
   * \param input1_err2 (INPUT) is the square of the uncertainty in
   *        the scalar to be divided from
   * \param input2 (INPUT) is the scalar to divide by
   * \param input2_err2 (INPUT) is the square of the uncertainty in the
   *        scalar to divide by
   * \param output (OUTPUT) the result scalar
   * \param output_err2 (OUTPUT) the square of the uncertainty in the
   * result scalar
  ...
  /**
   * \brief This function is described in section 3.8 except both
   * arrays are single values
   *
   * This function multiplies two scalars according to the equation
   * \f[
   ...
   * scalar, \f$\sigma_1\f$ is the uncertainty in the first scalar, and 
   * \f$\sigma_2\f$ is the uncertainty in the second scalar.
   *
   * This function is an adaptation from the ARCS reduction software
   * written by Tim Kelley (CalTech).
   *
   * \param input1 (INPUT) is the first scalar to be multiplied
   * \param input1_err2 (INPUT) is the square of the uncertainty
   *        in the first scalar to be multiplied
   * \param input2 (INPUT) is the second scalar to be multiplied
   * \param input2_err2 (INPUT) is the square of the uncertainty
   *        in the second scalar to be multiplied
   * \param output (OUTPUT) the result scalar
   * \param output_err2 (OUTPUT) the square of the uncertainty
   *        in the result scalar
   *
   * \param temp holds temporary memory to be passed to the function
   *
   * \return A set of warnings generated by the function
   ...
   * As an example, \f$2-4\f$ will return \f$UINT\_MAX-1\f$, where
   * \f$UINT\_MAX\f$ is the largest value that will fit in an unsigned int.
   * Because the true result of the equation is negative, 
   * which is not allowed with unsigned int, the result is wrapped around 0.
   * To generalize, the result with unsiged int is
   * \f[
   * result_{returned}=(result_{real})\ \%\ (UINT\_MAX+1)
   * \f]
 ...
 /**
  ...
  /**
   * \brief This function is described in section 3.7 except both arrays
   * are single values.
   *
   * This function subtracts two scalars according to the equation
   * \f[
   * data_o = data_1 - data_2
   * \f]
   * and the uncorrelated uncertainties will be processed according to
   ...
   * \sigma_o^2=\sigma_1^2+\sigma_2^2
   * \f]
   * where \f$data_o\f$ is the output scalar, \f$data_1\f$ is the scalar 
   * being subtracted from, \f$data_2\f$ is the subtracting scalar,
   * \f$\sigma_o\f$ is the uncertainty of the output scalar, \f$\sigma_1\f$
   * is the uncertainty in the scalar being subtracted from and 
   * \f$\sigma_2\f$ is the uncertainty in the subtracting scalar.
   *
   * This function is an adaptation from the ARCS reduction software written
   * by Tim Kelley (calTech).
   *
   * \param input1 (INPUT) is the scalar to be subtracted from
   * \param input1_err2 (INPUT) is the square of the uncertainty in the scalar
   *        to be subtracted from
   * \param input2 (INPUT) is the scalar to subtract
   * \param input2_err2 (INPUT) is the square of the uncertainty in the scalar
   *        to subtract
   * \param output (OUTPUT) is the result scalar
   * \param output_err2 (OUTPUT) is the square of the uncertainty in the result
   * scalar
   *
   * \param temp holds temporary memory to be passed to the function
   *
   * \return A set of wrnings generated by the function
   *
   * <b>Warning when using integers</b>
   * One must be aware of the overflow property when using integers.
   * The overflow occurs when trying to use negative numbers with unsigned 
   ...
   *
   * \exception std::invalid_argument is thrown if the size of input1,
   * input1_err2, input2, input2_err2, output, output_err2 are not
   * identical.
   */
  template <typename NumT>
  std::string
