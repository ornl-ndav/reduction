...
namespace AxisManip
{
  ...
  /**
   * \defgroup energy_to_wavelength AxisManip::energy_to_wavelength
   * \{
   */
   ...
   * \return A set of warnings generated by the function
   *
   * \exception std::invalid_argument is thrown if the size of energy, 
   * energy_err2, wavelength and wavelength_err2 are not identical.
   */
  template <typename NumT>
  std::string
  energy_to_wavelength(Nessi::Vector<NumT> const & energy,
                       Nessi::Vector<NumT> const & energy_err2,
   ...
   * energy according to the equation
   * \f[
   * \lambda=\sqrt{\frac{h^2}{2 m_n E}}
   * \f]
   * where \f$\lambda\f$ is the wavelength of the neutron, \f$h\f$ is Planck's
   * constant, \f$m_n\f$ is the mass of the neutron and \f$E\f$ is energy of 
   * the neutron.
   *
   * Assuming that the uncertainties are uncorrelated, the uncertainty
   * in the wavelength is defined by
   * \f[
   * \sigma^2_{\lambda}=\left(\frac{\lambda}{2E}\right)^2\sigma^2_E
   * \f]
   * where \f$\sigma_{\lambda}\f$ is the uncertainty in the wavelength axis 
   * and \f$\sigma_E\f$ is the uncertainty in the energy.
   *
   * \param energy (INPUT) is the energy of the neutron in units of meV
   * \param energy_err2 (INPUT) is the square of the uncertainty in the energy
   * \param wavelength (OUTPUT) is the wavelength axis in units of angstroms
  ...
  /**
   * \}
   */ // end of energy_to_wavelength group
   ...
   * \left(\frac{m_n}{h}\right)^2\left(\left(
   * \lambda_f\right)^2\sigma^2_{L_D} + \left({L_D}\right)^2
   * \sigma^2_{\lambda_f}\right)\right)
   * \f]
   *
  ...
  /**
   * \defgroup tof_to_wavelength_lin_time_zero AxisManip::tof_to_wavelength_lin_time_zero
   * \{
   */

  /**
   * \brief This function is described in section 3.50.
   *
   * This function converts the time-of-flight to wavelength according
   * to the equation
   *
  ...
  template <typename NumT>
  std::string
  tof_to_wavelength_lin_time_zero(Nessi::Vector<NumT> const & tof,
                                  Nessi::Vector<NumT> const & tof_err2,
                                  const NumT pathlength,
                                  const NumT pathlength_err2,
                                  const NumT time_0_slope,
   ...
   *
   * \f[
   * \lambda=\frac{TOF - t_{0,offset}}{\frac{m_n L}{h} + t_{0,slope}} 
   * \f]
   *
   * where \f$\lambda\f$ is the wavelength, \f$h\f$ is Planck's
   * constant, \f$TOF\f$ is the time-of-flight, \f$m_n\f$ is the mass
   ...
   *
   * \f[
   * \sigma^2_{\lambda}=\left(\frac{1}{\frac{m_n L}{h} + t_{0,slope}}\right)^2 
   * \times \left(\sigma^2_{TOF} + \sigma^2_{t_{0,offset}} + \lambda^2 
   * \left(\left(\frac{m_n}{h}\right)^2\sigma^2_L + \sigma^2_{t_{0,slope}}
   * \right)\right)
   * \f]
   * 
   * where \f$\sigma_{\lambda}\f$ is the uncertainty in the wavelength axis,
  ...
  /**
   * \}
   */ // end of tof_to_wavelength_lin_time_zero group
  ...
  /**
   * \defgroup velocity_to_wavelength AxisManip::velocity_to_wavelength
   * \{
   */

  /**
   * \brief This function is described in section 3.58.
   *
   ...
   *
   * Assuming that the uncertainties are uncorrelated, the square of the 
   * uncertainty in wavelength is given by
   * \f[
   ...
   *
   * \param velocity (INPUT) is the velocity axis in units of 
   * meter/micro-seconds
   ...
   * uncertainty in wavelength is given by
   * \f[
   * \sigma^2_{\lambda} = \left(\frac{\lambda}{v}\right)^2 \sigma^2_v
   * \f]
  ...
  /**
   * \}
   */ // end of velocity_to_wavelength group
  ...
  /**
   * \}
   */ // end of wavelength_to_velocity group
