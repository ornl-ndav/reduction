 ...
 * $Id$
 *
 * \file axis_manip/test/cpp/tof_to_wavelength_lin_time_zero_test.cpp
 */
 ...
 * function <i>tof_to_wavelength_lin_time_zero</i> and described in 3.50
...
/**
 * This function initializes the value of arrays, \f$tof\f$ and 
 * \f$tof\_err2\f$. *
 ...
 * outputs generated by the <i>tof_to_wavelength_lin_time_zero</i> function 
 ...
 * <i>tof_to_wavelength_lin_time_zero</i> for the ss case
 * \param output_ss_err2 (INPUT) is the square of the uncertainty of the value
 * created by <i>tof_to_wavelength_lin_time_zero</i> for the ss case
 ...
 * <i>tof_to_wavelength_lin_time_zero</i> for the vv case
 * \param output_vv_err2 (INPUT) is the square of the uncertainty of the value
 * created by <i>tof_to_wavelength_lin_time_zero</i> for the vv case
 ...
 * <i>tof_to_wavelength_lin_time_zero</i> function
...
// allocate arrays
  ...
  AxisManip::tof_to_wavelength_lin_time_zero(tof[0], tof_err2[0],
  ...
  AxisManip::tof_to_wavelength_lin_time_zero(tof, tof_err2,
                                             pathlength, pathlength_err2,
                                             time_0_slope, time_0_slope_err2,
                                             time_0_offset, time_0_offset_err2,
                                             output_vv,
...
/**
 * Main function that test tof_to_wavelength_lin_time_zero for float and double
 *
...
{
  cout << "tof_to_wavelength_lin_time_zero_test.cpp..........";
...
/**
 * \}
 */  // end of tof_to_wavelength_lin_time_zero_test.cpp group
