                             ...
                             Nessi::Vector<NumT> & true_frac_area)
{
  ...
  true_output.push_back(static_cast<NumT>(35.0));
  true_output.push_back(static_cast<NumT>(35.0));

  true_output_err2.push_back(static_cast<NumT>(5.0));
  true_output_err2.push_back(static_cast<NumT>(5.25));
  true_output_err2.push_back(static_cast<NumT>(6.25));

  true_frac_area.push_back(static_cast<NumT>(3.0));
  true_frac_area.push_back(static_cast<NumT>(3.5));
  true_frac_area.push_back(static_cast<NumT>(3.5));
}
