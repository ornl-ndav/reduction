...
int main() 
{
  ...
  while (1)
  {
    Utils::fd_comparison(f_Q, f_true_Q, error_case_1, 10, num_val);
    if (error_case_1 != 0) break;
    Utils::fd_comparison(f_Q_err2, f_true_Q_err2, error_case_1, 20, num_val);
    if (error_case_1 != 0) break;
    Utils::fd_comparison(d_Q, d_true_Q, error_case_1, 110, num_val);
    if (error_case_1 != 0) break;
    Utils::fd_comparison(d_Q_err2, d_true_Q_err2, error_case_1, 120, num_val);
    break;
   }
  ...
  while (1)
    {
  Utils::fd_comparison(f_Q, f_true_Q, error_case_2, 10, num_val);
    if (error_case_2 != 0) break;
  Utils::fd_comparison(f_Q_err2, f_true_Q_err2, error_case_2, 20, num_val);
    if (error_case_2 != 0) break;
  Utils::fd_comparison(d_Q, d_true_Q, error_case_2, 110, num_val);
    if (error_case_2 != 0) break;
  Utils::fd_comparison(d_Q_err2, d_true_Q_err2, error_case_2, 120, num_val);
    if (error_case_2 != 0) break;
  break;   
    }  
  ...
  while (1)
    {
      Utils::fd_comparison(f_Q, f_true_Q, error_case_4, 10, num_val);
      if (error_case_4 != 0) break;
      Utils::fd_comparison(f_Q_err2, f_true_Q_err2, error_case_4, 20, num_val);
      if (error_case_4 != 0) break;
      Utils::fd_comparison(d_Q, d_true_Q, error_case_4, 110, num_val);
      if (error_case_4 != 0) break;
      Utils::fd_comparison(d_Q_err2, d_true_Q_err2, error_case_4, 120,num_val);
      if (error_case_4 != 0) break;
      break;   
    }  
