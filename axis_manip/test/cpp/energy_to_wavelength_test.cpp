 ...
 * $Id$
 *
 * \file axis_manip/test/cpp/energy_to_wavelength_test.cpp
 */
 ...
 * function <i>energy_to_wavelength</i> and described in 3.51
...
/**
 * This function initializes the value of arrays, \f$energy\f$ and
 * \f$energy\_err2\f$.
 *
 * \param energy (OUTPUT) is the energy axis in units of Angstroms
 * \param energy_err2 (OUTPUT) is the square of the uncertainty in the
 * energy axis
 */
template <typename NumT>
void initialize_inputs(Nessi::Vector<NumT> & energy,
                       Nessi::Vector<NumT> & energy_err2)
{
  for( size_t i=0 ; i<NUM_VAL ; i++ )
    {
      energy.push_back(static_cast<NumT>(i+1));
      energy_err2.push_back(static_cast<NumT>(i+0.5));
    }
}

/**
 * This function sets the true outputs based on values contained in
 * \f$energy\f$ and \f$energy\_err2\f$ for the float case.
 *
...
{
  // scalar scalar
  true_output_ss=static_cast<float>(9.04456771);
  true_output_ss_err2=static_cast<float>(0.01382045);

  // vector vector
  true_output_vv.push_back(static_cast<float>(9.04456771));
  true_output_vv_err2.push_back(static_cast<float>(0.01382045));
  true_output_vv.push_back(static_cast<float>(6.39547516));
  true_output_vv_err2.push_back(static_cast<float>(0.11727041));
  true_output_vv.push_back(static_cast<float>(5.22188360));
  true_output_vv_err2.push_back(static_cast<float>(0.35906584));
  true_output_vv.push_back(static_cast<float>(4.52228386));
  true_output_vv_err2.push_back(static_cast<float>(0.77394523));
  true_output_vv.push_back(static_cast<float>(4.04485365));
  true_output_vv_err2.push_back(static_cast<float>(1.39065600));
}
...
{
  // scalar scalar
  true_output_ss=static_cast<double>(9.04456771216844935);
  true_output_ss_err2=static_cast<double>(0.0138204504602056893);

  // vector vector
  true_output_vv.push_back(static_cast<double>(9.04456771216844935));
  true_output_vv_err2.push_back(static_cast<double>(0.0138204504602056893));
  true_output_vv.push_back(static_cast<double>(6.39547516217520773));
  true_output_vv_err2.push_back(static_cast<double>(0.117270410873570263));
  true_output_vv.push_back(static_cast<double>(5.22188360332425106));
  true_output_vv_err2.push_back(static_cast<double>(0.359065835708474113));
  true_output_vv.push_back(static_cast<double>(4.52228385608422467));
  true_output_vv_err2.push_back(static_cast<double>(0.773945225771518586));
  true_output_vv.push_back(static_cast<double>(4.04485364630168043));
  true_output_vv_err2.push_back(static_cast<double>(1.39065600189096839));
}

/**
 * Function that tests the discrepancies between the true outputs and the
 * outputs generated by the <i>energy_to_wavelength</i> function for the ss and
 * vv cases.
 *
 ...
 *
 * \param output_ss (INPUT) is the value created by <i>energy_to_wavelength</i>
 * for the ss case
 * \param output_ss_err2 (INPUT) is the square of the uncertainty of the value
 * created by <i>energy_to_wavelength</i> for the ss case
 ...
 * \param output_vv (INPUT) is the value created by <i>energy_to_wavelength</i>
 * for the vv case
 * \param output_vv_err2 (INPUT) is the square of the uncertainty of the value
 * created by <i>energy_to_wavelength</i> for the vv case
...
/**
 * Function that generates the data using the <i>energy_to_wavelength</i>
 * function (as described in the documentation of the
 * <i>energy_to_wavelength</i> function) and launches the comparison of the
 * data.
 *
...
bool test_func(NumT key, string debug) // key forces correct test to happen
{
  ...
  initialize_inputs(energy,energy_err2);
  initialize_true_outputs(true_output_ss, true_output_ss_err2,
                          true_output_vv, true_output_vv_err2);

  // run the code being tested
  AxisManip::energy_to_wavelength(energy[0], energy_err2[0],
                                  output_ss, output_ss_err2);

  AxisManip::energy_to_wavelength(energy, energy_err2,
...
/**
 * Main function that test energy_to_wavelength for float and double
 *
...
{
  cout << "energy_to_wavelength_test.cpp..........";
...
/**
 * \}
 */  // end of energy_to_wavelength_test group
