 ...
 * described in section 3.4, 3.5 and 3.9 of the <i>DR_Lib_RS_1</i> with the
 ...
 *
 * This function initializes \f$NUM\_VAL\f$ values of each array, \f$input1\f$
 * and \f$input2\f$.
 *
 ...
 *
 * \param output_vs (INPUT) is the result array created by <i>div_ncerr</i>
 * for the vs case
 ...
 * \param output_sv (INPUT) is the result array created by <i>div_ncerr</i>
 * for the sv case
 ...
 * \param output_vv (INPUT) is the result array created by <i>div_ncerr</i>
 * for the vv case
 ...
 *
 * \param input1 (INPUT) is the array to be dividedfrom
 ...
 * to divide by
 * \param output_vs (OUTPUT) is the result array created by <i>div_ncerr</i>
 * for the vs case
 * \param output_vs_err2 (OUTPUT) is the square of the uncertainty in the
 * result array created by <i>div_ncerr</i> for the vs case
 * \param output_sv (OUTPUT) is the result array created <i>div_ncerr</i> for
 * the sv case
 * \param output_sv_err2 (OUTPUT) is the square of the uncertainty in the
 * result array created by <i>div_ncerr</i> for the sv case
 * \param output_vv (OUTPUT) is the result array created by <i>div_ncerr</i>
 * for the vv case
 * \param output_vv_err2 (OUTPUT) is the square of the uncertainty in the
 * result array created <i>div_ncerr</i> for the vv case
...
/**
 * Main function that testes <i>div_ncerr</i> for
