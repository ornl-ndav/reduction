...
int main() 
{
  ...
  ArrayManip::mult_vec_vec_ncerr(f_input1, f_input1_err2, f_input2, 
				 f_input2_err2, f_output, f_output_err2);
  ArrayManip::mult_vec_vec_ncerr(d_input1, d_input1_err2, d_input2, 
				 d_input2_err2, d_output, d_output_err2);
  ArrayManip::mult_vec_vec_ncerr(i_input1, i_input1_err2, i_input2, 
				 i_input2_err2, i_output, i_output_err2);
  ArrayManip::mult_vec_vec_ncerr(u_input1, u_input1_err2, u_input2, 
  ...
  cout << "mult_vec_vec_ncerr_test.cpp..........";
