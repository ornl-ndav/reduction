 ...
 * section 3.1 and 3.6 of the <i>DR_Lib_RS_1</i> with the true output data
 ...
 *
 * \param output_vs (INPUT) is the result array created by <i>add_ncerr</i>
 * for the vs case
 ...
 * \param output_vv (INPUT) is the result array created by <i>add_ncerr</i>
 * for the vv case
 ...
 * array to be added
 * \param output_vs (OUTPUT) is the result array created by <i>add_ncerr</i>
 * for the vs case
 * \param output_vs_err2 (OUTPUT) is the square of the uncertainty in the
 * result
 * \param output_vv (OUTPUT) is the result array created by <i>add_ncerr</i>
 * for the vv case
 * \param output_vv_err2 (OUTPUT) is the square of the uncertainty in the
 * result array created by <i>add_ncerr</i> for the vv case
...
/**
 * Main function that testes <i>add_ncerr</i> for
