 ...
 * section 3.3 and 3.8 of the <i>DR_Lib_RS_1</i> with the true output data
 * (\f$true\_output\_vs\f$ and (\f$true\_output\_vv\f$) manually calculated .
 ...
 *
 * \param output_vs (INPUT) is the result array created by <i>mult_ncerr</i> for the
 * vs case
 * \param output_vs_err2 (INPUT) is the square of the uncertainty in the result
 * array created by <i>mult_ncerr</i> for the vs case
 ...
 * \param output_vv (INPUT) is the result array created by <i>mult_ncerr</i> for the
 * vv case
 ...
 * \param input1_err2 (INPUT) is the square of the uncertainty in the first
 * array to be multiplied
 * \param input2 (INPUT) is the second array to be multiplied
 * \param input2_err2 (INPUT) is the square of the uncertainty in the second
 * array to be multiplied
 * \param output_vs (OUTPUT) is the result array created by <i>mult_ncerr</i> for the
 * vs case
 * \param output_vs_err2 (OUTPUT) is the square of the uncertainty in the result
 * \param output_vv (OUTPUT) is the result array created by <i>mult_ncerr</i> for the
 * vv case
 * \param output_vv_err2 (OUTPUT) is the square of the uncertainty in the result
 * array created by <i>mult_ncerr</i> for the vv case
...
/**
 * Main function that testes <i>mult_ncerr</i> for
