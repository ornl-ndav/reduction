...
/**
 * \defgroup sub_ncerr_test
 * \{
 *
 * This test compares the output data (\f$output\_sv\f$, \f$output\_vs\f$ and
 * \f$output\_vv\f$) calculated by the library function <i>sub_ncerr</i> and
 * described in section 3.2, 3.8 and 3.44 of the <i>DR_Lib_RS_1</i> with the
 * true output data (\f$true\_output\_sv\f$, \f$true\_output\_vs\f$ and
 ...
 * generated by the <i>sub_ncerr</i> function for the vs, sv and vv cases.
 ...
 *
 * \param output_vs (INPUT) is the result array created by <i>sub_ncerr</i>
 * for the vs case
 ...
 * \param output_sv (INPUT) is the result array created by <i>sub_ncerr</i>
 * for the sv case
 ...
 * \param output_vv (INPUT) is the result array created by <i>sub_ncerr</i>
 * for the vv case
 ...
 * \param input1_err2 (INPUT) is the square of the uncertainty in the array
 * to be subtracted from
 * \param input2 (INPUT) is the array to subtract
 * \param input2_err2 (INPUT) is the square of the uncertainty in the array
 * to subtract
 * \param output_vs (OUTPUT) is the result array created by <i>sub_ncerr</i>
 * for the vs case
 * \param output_vs_err2 (OUTPUT) is the square of the uncertainty in the
 * result array created by <i>sub_ncerr</i> for the vs case
 * \param output_sv (OUTPUT) is the result array created by <i>sub_ncerr</i>
 * for the sv case
 * \param output_sv_err2 (OUTPUT) is the square of the uncertainty in the
 * result array created by <i>sub_ncerr</i> for the sv case
 * \param output_vv (OUTPUT) is the result array created by <i>sub_ncerr</i>
 * for the vv case
 * \param output_vv_err2 (OUTPUT) is the square of the uncertainty in the
 * result array created by <i>sub_ncerr</i> for the vv case
 * \param true_output_vs (OUTPUT) is the true result array for the vs case
 * \param true_output_vs_err2 (OUTPUT) is the square of the uncertainty in the
 * true result array for the vs case
 * \param true_output_sv (OUTPUT) is the true result array for the sv case
 * \param true_output_sv_err2 (OUTPUT) is the square of the uncertainty in the
 * true result array for the sv case
 * \param true_output_vv (OUTPUT) is the true result array for the vv case
 * \param true_output_vv_err2 (OUTPUT) is the square of the uncertainty in the
 * true result array for the vv case
*/
template <typename NumT>
...
/**
 * Main function that testes <i>sub_ncerr</i> for
