...
namespace ArrayManip
{
   ...
   */
  template std::string 
  div_scalar_vec_ncerr<float>(Nessi::Vector<float> const & array_in, 
   ...
   */
  template std::string 
  div_scalar_vec_ncerr<double>(Nessi::Vector<double> const & array_in, 
   ...
   */
  template std::string 
  div_scalar_vec_ncerr<int>(Nessi::Vector<int> const & array_in, 
