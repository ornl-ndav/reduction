...
print
print "####Checking Array Manipulation Package for unsigned int####"

#Initialization of vectors a and b
a = NessiVector(0,"uint")
a.append(2)
a.append(4)
a.append(6)

ae2 = NessiVector(0,"uint")
ae2.append(0)
ae2.append(1)
ae2.append(2)

b = NessiVector(0,"uint")
b.append(1)
b.append(4)
b.append(7)

be2 = NessiVector(0,"uint")
be2.append(0)
be2.append(1)
be2.append(2)  

c = NessiVector(len(a),"uint")
ce2 = NessiVector(len(ae2),"uint")
