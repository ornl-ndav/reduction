...
namespace ArrayManip
{
   ...
   */
  template std::string
  mult_ncerr<float>(const float input1,
  ...
  /**
   * This is the double declaration of the function defined in 3.8.
   *
   * \ingroup mult_ncerr
   */
  template std::string
  mult_ncerr<double>(const double input1,
  ...
  /**
   * This is the int declaration of the function defined in 3.8.
   *
   * \ingroup mult_ncerr
   */
  template std::string
  mult_ncerr<int>(const int input1,
  ...
  /**
   * This is the unsigned int declaration of the function defined in 3.8.
   *
   * \ingroup mult_ncerr
   */
  template std::string
  mult_ncerr<unsigned int>(const unsigned int input1,
