 ...
 * $Id$
 *
 * \file axis_manip/src/rebin_axis_1D_frac.cpp
 */
#include "rebin_axis_1D_frac.hpp"
...
namespace AxisManip
{
  ...
  /**
   * This is the float declaration of the function defined in 3.62.
   *
   * \ingroup rebin_axis_1D_frac
   */
  template std::string
  rebin_axis_1D_frac<float>(const Nessi::Vector<float> & axis_in,
   ...
   */
  template std::string
  rebin_axis_1D_frac<double>(const Nessi::Vector<double> & axis_in,
