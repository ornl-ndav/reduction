 ...
 * $Id$
 *
 * \file axis_manip/src/tof_to_initial_wavelength_igs_lin_time_zero.cpp
 */
#include "tof_to_initial_wavelength_igs_lin_time_zero.hpp"
...
namespace AxisManip
{
   ...
   */
  template std::string
  tof_to_initial_wavelength_igs_lin_time_zero<float>(
   ...
   */
  template std::string
  tof_to_initial_wavelength_igs_lin_time_zero<double>(
