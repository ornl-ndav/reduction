 ...
 * <i>div_ncerr</i> and described in section 3.4, 3.5 and 3.9 of the 
 ...
 *
 * For the ss case, the scalars used are the last elements of the
 * array \f$input1\f$, \f$input1[NUM\_VAL-1]\f$, \f$input2\f$,
                             ...
                             NumT                & true_output_ss_err2)
{
  ...
  true_output_ss = static_cast<NumT>(5.); // =10/2
  true_output_ss_err2 = static_cast<NumT>(6.5);
}

/**
 * Function that tests the discrepancies between the output
 * generated by the <i>div_ncerr</i> function for the vs, sv, vv, and ss cases.
...
bool test_func(NumT key, string debug){ // key forces correct test to happen
  ...
  ArrayManip::div_ncerr(input1[0], input1_err2[0],
                        input2[0], input2_err2[0],
