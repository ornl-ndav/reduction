...
TruthOutput_VV_F.append(0.0007912067)
TruthOutput_VV_F.append(0.0015824135)
TruthOutput_VV_F.append(0.0023736204)
TruthOutput_VV_F.append(0.0031648271)
TruthOutput_VV_F.append(0.0039560338)
...
TruthOutput_Err2_VV_F.append(0.0000003756)
TruthOutput_Err2_VV_F.append(0.0000011894)
TruthOutput_Err2_VV_F.append(0.0000021284)
TruthOutput_Err2_VV_F.append(0.0000031926)
TruthOutput_Err2_VV_F.append(0.0000043820)
...
TruthOutput_SS_F = 0.0007912067

TruthOutput_SS_D = 0.00079120679999999

TruthOutput_Err2_SS_F = 0.0000003756
...
tof_to_wavelength_f(Input_F, Input_Err2_F,
                    pathlength, pathlength_err2,
                    Output_VV_F, Output_Err2_VV_F)

mess = test_common_bind.makeCheck("tof_to_wavelength_f",
                                  Output_VV_F,
                                  TruthOutput_VV_F,
                                  Output_Err2_VV_F,
...
tof_to_wavelength_f(Input_F[0], Input_Err2_F[0],
                    pathlength, pathlength_err2,
