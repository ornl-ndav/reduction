 ...
 * $Id$
 *
 * \file axis_manip/test/cpp/velocity_to_wavelength_test.cpp
 */
...
/**
 * \defgroup velocity_to_wavelength_test velocity_to_wavelength_test
 * \{
 *
 * This test compares the output data calculated by the library
 * function <i>velocity_to_wavelength</i> and described in 3.58
                       ...
                       Nessi::Vector<NumT> & velocity_err2)
{
  for( size_t i = 0; i < NUM_VAL; ++i )
    {
      velocity.push_back(static_cast<NumT>(i+1));
      velocity_err2.push_back(static_cast<NumT>(i+0.5));
    }
}
 ...
 * (\f$velocity\_i[0]\f$ and \f$velocity\_err2[0]\f$).
 *
 ...
 * outputs generated by the <i>velocity_to_wavelength</i> function for the ss 
 * and vv cases.
 *
 ...
 * <i>velocity_to_wavelength</i> for the ss case
 * \param output_ss_err2 (INPUT) is the square of the uncertainty of the value
 * created by <i>velocity_to_wavelength</i> for the ss case
 ...
 * <i>velocity_to_wavelength</i> for the vv case
 * \param output_vv_err2 (INPUT) is the square of the uncertainty of the value
 * created by <i>velocity_to_wavelength</i> for the vv case
...
/**
 * Function that generates the data using the <i>velocity_to_wavelength</i> 
 * function (as described in the documentation of the 
 * <i>velocity_to_wavelength</i> function) and launches the comparison of the 
 * data.
 *
...
// allocate arrays
  ...
  AxisManip::velocity_to_wavelength(velocity[0], velocity_err2[0],
                                    output_ss,
                                    output_ss_err2);

  AxisManip::velocity_to_wavelength(velocity, velocity_err2,
                                    output_vv,
                                    output_vv_err2);
...
/**
 * Main function that test velocity_to_wavelength for float and double
 *
...
{
  cout << "velocity_to_wavelength_test.cpp..........";
...
/**
 * \}
 */  // end of velocity_to_wavelength_test.cpp group
