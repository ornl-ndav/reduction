...
# $Id$
#
# \file bindings/test/PAL/rebin_axis_2D_test.py
#
...
##
# \defgroup rebin_axis_2D_test rebin_axis_2D_test
# \{
#
# This test compares the output data (\f$output\_vv\f$) calculated by the
# binding module <i>rebin_axis_2D.py</i> of the Python Abstration Layer (PAL)
...
def initialize_true_outputs(key):
    ...
    if (key == "double"):
      ...
      # initialize the correct outputs for vector vector case
        ...
        true_output_vv.append(float(60))
        true_output_vv.append(float(30))
        true_output_vv.append(float(60))

        true_output_vv_err2.append(float(2.5))
        true_output_vv_err2.append(float(12.5))
        true_output_vv_err2.append(float(2.5))
        true_output_vv_err2.append(float(12.5))
