...
namespace Utils
{
  ...
  /**
   * \brief This function is described in section 3.68
   * 
   ...
   *
   * \param e1_axis (INPUT) is the first energy transfer vertex coordinate 
   * array
   * \param e2_axis (INPUT) is the second energy transfer vertex coordinate 
   * array
   * \param e3_axis (INPUT) is the third energy transfer vertex coordinate 
   * array
   * \param e4_axis (INPUT) is the fourth energy transfer vertex coordinate 
   * array
   * \param q1_axis (INPUT) is the first momentum transfer vertex coordinate 
   * array
   * \param q2_axis (INPUT) is the second momentum transfer vertex coordinate 
   * array
   * \param q3_axis (INPUT) is the third momentum transfer vertex coordinate 
   * array
   * \param q4_axis (INPUT) is the fourth momentum transfer vertex coordinate 
   * array
   * \param jacobian (OUTPUT) is the calculated Jacobian for each set of 
   * vertex coordinates
   * \param temp  holds temporary memory to be passed to the function
   *
   * \return A set of warnings generated by the function
