 ...
 * section 3.1 of the <i>DR_Lib_RS_1</i> with the true output data
 ...
 *
 * \param output_vv (INPUT) is the result array created by <i>sumw_ncerr</i>
 * for the vv case
 ...
 * array to be added
 * \param output_vv (OUTPUT) is the result array created by <i>sumw_ncerr</i>
 * for the vv case
 * \param output_vv_err2 (OUTPUT) is the square of the uncertainty in the
 * result array created by <i>sumw_ncerr</i> for the vv case
...
/**
 * Main function that testes <i>sumw_ncerr</i> for
