...
/**
 * \ingroup sumw_ncerr_test
 *
 * This test compares the output data (\f$output_vs\f$ and \f$output_vv\f$)
 * calculated by the library function sumw_ncerr and described in
 * section 3.1 of the DR_Lib_RS_1 with the true output data
 ...
 * generated by the sumw_ncerr function for the vv case.
 ...
 *
 * \param output_vv (INPUT) is the result array created by sumw_ncerr for the
 * vv
 * case
 * \param output_vv_err2 (INPUT) is the square of the uncertainty in the result
 * array created by sumw_ncerr for the vv case
...
/**
 * Function that generates the data using the sumw_ncerr function
 * (as described in the documentation of the sumw_ncerr function)
...
/**
 * Main function that testes sumw_ncerr for
