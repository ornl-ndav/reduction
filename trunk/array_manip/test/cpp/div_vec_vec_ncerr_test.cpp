...
int main() 
{
  ...
  for (int i = 0 ; i < num_val ; ++i)
	...
	(((f_input1[i] * f_input1[i]) / (f_input2_2 * f_input2_2)) * 
	 f_input2_err2[i]);

      d_true_vector_err2[i] = (d_input1_err2[i] / d_input2_2) +
	(((d_input1[i] * d_input1[i]) / (d_input2_2 * d_input2_2)) * 
	 d_input2_err2[i]);

      i_true_vector_err2[i] = (i_input1_err2[i] / i_input2_2) +
	(((i_input1[i] * i_input1[i]) / (i_input2_2 * i_input2_2)) * 
	 i_input2_err2[i]);

      u_true_vector_err2[i] = (u_input1_err2[i] / u_input2_2) +
	(((u_input1[i] * u_input1[i]) / (u_input2_2 * u_input2_2)) * 
	 u_input2_err2[i]);      
    }
