...
int main() 
{
  ...
  ArrayManip::div_vec_vec_ncerr(f_input1, f_input1_err2, f_input2, 
				 f_input2_err2, f_output, f_output_err2);
  ArrayManip::div_vec_vec_ncerr(d_input1, d_input1_err2, d_input2, 
				 d_input2_err2, d_output, d_output_err2);
  ArrayManip::div_vec_vec_ncerr(i_input1, i_input1_err2, i_input2, 
  ...
  for (int i=0; i<n; i++)
    {
      ...
      f_true_vector_err2[i] = (f_input1_err2[i] / f_input2_2) +
	(((f_input1[i] * f_input1[i]) / (f_input2_2 * f_input2_2)) * f_input2_err2[i]);
      d_true_vector_err2[i] = (d_input1_err2[i] / d_input2_2) +
	(((d_input1[i] * d_input1[i]) / (d_input2_2 * d_input2_2)) * d_input2_err2[i]);
      i_true_vector_err2[i] = (i_input1_err2[i] / i_input2_2) +
	(((i_input1[i] * i_input1[i]) / (i_input2_2 * i_input2_2)) * i_input2_err2[i]);
      u_true_vector_err2[i] = (u_input1_err2[i] / u_input2_2) +
	(((u_input1[i] * u_input1[i]) / (u_input2_2 * u_input2_2)) * u_input2_err2[i]);      
    }
  ...
  cout << "div_vec_vec_ncerr_test.cpp..........";
