...
int main() 
{
  ...
  ArrayManip::sub_scalar_vec_ncerr(f_input, f_input_err2, f_output, f_output_err2, f_scalar, f_scalar_err2);
  ArrayManip::sub_scalar_vec_ncerr(d_input, d_input_err2, d_output, d_output_err2, d_scalar, d_scalar_err2);
  ArrayManip::sub_scalar_vec_ncerr(i_input, i_input_err2, i_output, i_output_err2, i_scalar, i_scalar_err2);
  ArrayManip::sub_scalar_vec_ncerr(u_input, u_input_err2, u_output, u_output_err2, u_scalar, u_scalar_err2);
  ...
  cout << "sub_scalar_vec_ncerr_test.cpp..........";
