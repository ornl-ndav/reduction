...
int main() 
{
  ...
  ArrayManip::add_scalar_vec_ncerr(d_input, d_input_err2,
				   d_output, d_output_err2, 
				   d_scalar, d_scalar_err2);

  ArrayManip::add_scalar_vec_ncerr(i_input, i_input_err2,
				   i_output, i_output_err2, 
				   i_scalar, i_scalar_err2);

  ArrayManip::add_scalar_vec_ncerr(u_input, u_input_err2,
