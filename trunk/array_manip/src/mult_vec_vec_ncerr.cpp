 ...
 */
#include "mult_vec_vec_ncerr.hpp"
...
namespace ArrayManip
{
   ...
   */
  template std::string 
  mult_vec_vec_ncerr<float>(Nessi::Vector<float> const & input1, 
   ...
   */
  template std::string 
  mult_vec_vec_ncerr<double>(Nessi::Vector<double> const & input1, 
   ...
   */
  template std::string 
  mult_vec_vec_ncerr<int>(Nessi::Vector<int> const & input1, 
