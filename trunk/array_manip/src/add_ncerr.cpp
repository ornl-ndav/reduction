...
namespace ArrayManip
{
   ...
   */
  template std::string
  add_ncerr<float>(const float input1,
  ...
  /**
   * This is the double declaration of the function defined in 3.6.
   *
   * \ingroup add_ncerr
   */
  template std::string
  add_ncerr<double>(const double input1,
  ...
  /**
   * This is the int declaration of the function defined in 3.6.
   *
   * \ingroup add_ncerr
   */
  template std::string
  add_ncerr<int>(const int input1,
  ...
  /**
   * This is the unsigned int declaration of the function defined in 3.6.
   *
   * \ingroup add_ncerr
   */
  template std::string
  add_ncerr<unsigned int>(const unsigned int input1,
