...
#ifdef LINUX
  true_output_err2.push_back(static_cast<float>(4.95867625));
#else
...
#ifdef LINUX
  true_output.push_back(static_cast<float>(45.45454927));
#else
...
#ifdef LINUX
  true_output.push_back(static_cast<double>(27.2727272727272698));
#else
