 ...
 * $Id$
 *
 * \file utils/src/edge_intersect.cpp
 */

#include "edge_intersect.hpp"
...
namespace Utils
{
  ...
  /**
   * This is the float declaration of the edge_intersect function
   *
  ...
  /**
   * This is the double precision float declaration of the edge_intersect
   *
   * \ingroup convex_polygon_intersect
   */
  template eEdgeOrient
